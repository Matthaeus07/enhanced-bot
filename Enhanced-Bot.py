...
class FastReplies(commands.Cog):
    @bot.slash_command(guild_ids = guilds)
    ...
    async def version(ctx):
        ...
        send = Embed(description=f"The current version of the {myid} is:  _**{version}**_", color=Colour.blurple())
        await ctx.respond(embed = send)
...
HELP_FASTREPLIES_CHOICES = ["● FastReplies", "▸ hello", "▸ ping", "▸ color", "▸ id", "▸ getid", "▸ version"]
